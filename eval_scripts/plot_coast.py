coast_list = "E:/data/deutsches_reich/wiki/highres/coast_list.txt"
...
colours = [ "r" if e in coasts else "b" for e in sheet_names_sorted]

import matplotlib.pyplot as plt

plt.bar(sheet_names_sorted, error_sorted,label="error, land",color=colours)
plt.bar([0], [0],label="error, coast",color="r")
