path_output = "E:/experiments/icc_usgs100_fixquery/"#E:/experiments/fullslub/" # end with slash /
# path_osm = "./data/osm_old/" # end with slash /
# path_osm = "E:/experiments/osm_drain_reproj/" # end with slash /
path_osm = path_output+"/osm/"#E:/experiments/osm_usgs100/" # end with slash /
path_logs = path_output + "logs/"#"E:/experiments/usgs250_small/"#"./logs/" # end with slash /
index_basepath = path_output + "index/"
...
index_lowes_test_ratio = 0.8 # None
...
reference_sheets_path = index_basepath+"/index/sheets.clf"
reference_index_path = index_basepath+"/index/index.ann"
reference_descriptors_path = index_basepath+"/index/index.clf"
reference_descriptors_folder = index_basepath+"/index/descriptors"
reference_keypoints_path = index_basepath+"/index/keypoints.clf"
reference_keypoints_folder = index_basepath+"/index/keypoints"

template_window_size = 30

segmentation_colourbalance_percent = 5
segmentation_blurkernel = (11,11)
