base_path="E:/experiments/icc_kdr500manual/"
...
base_index_path = base_path+"index/" #"E:/experiments/icc_kdr500/index/"
...
fill_polys = True
sheet_name_field = "blatt"

process_image_width = 1000 # image size to do all the processing in (retrieval and registration)
