path_output = "data/output/" # end with slash /
path_osm = "data/osm/" # end with slash /
path_logs = "data/logs/"#"./logs/" # end with slash /

proj_map = "+proj=longlat +ellps=bessel +towgs84=598.1,73.7,418.2,0.202,0.045,-2.455,6.7 +no_defs" # lat/lon with Potsdam datum
...
gdal_output_options = '-a_srs "' + proj_out + '" -a_nodata 0 -of JP2OpenJPEG -co "QUALITY=5"'
