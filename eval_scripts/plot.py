...
new_results = {"529":(143.55,148.26),#"12": (3184.05,3208.3),
...
# error_results = [new_results[x][0] for x in sheet_names] # MAE
error_results = [new_results[x][1] for x in sheet_names] # RMSE
