base_path = "E:/experiments/e12b_preu/"
path_output = base_path # end with slash /
path_logs = base_path # end with slash /
base_path_index = "E:/experiments/idx_tudr200_preu/"
...
segmentation_steps = [
            ...
            ("convert","hsv"),
            ("threshold",[(90, 35, 100),(110, 170, 240)]),
            ("open",5),
            ("close",11)
            ]
...
warp_mode_retrieval = "similarity" # ["similarity","affine"]
